...
/* to override these locally (with remote xul), create a server/skin/custom.js file containing lines like
    ...
    urls['AUDIO_good'] = '/xul/0master_6da2b4e/server/skin/media/custom/good.wav';
...
const CLIENT_VERSION = '0master.6da2b4e';
const CLIENT_STAMP   = '0master_6da2b4e';
...
var urls = {
    ...
    'AUDIO_good' : '/xul/0master_6da2b4e/server/skin/media/audio/bonus.wav',
    'AUDIO_bad' : '/xul/0master_6da2b4e/server/skin/media/audio/question.wav',
    'AUDIO_horrible' : '/xul/0master_6da2b4e/server/skin/media/audio/redalert.wav',
    'AUDIO_circ_good' : '/xul/0master_6da2b4e/server/skin/media/audio/toggled.wav',
    'AUDIO_circ_bad' : '/xul/0master_6da2b4e/server/skin/media/audio/question.wav',
    'AUDIO_event_ASSET_COPY_NOT_FOUND' : '/xul/0master_6da2b4e/server/skin/media/audio/redalert.wav',

    'AUTHORITY_MANAGE' : '/eg/cat/authority/list',
    'MANAGE_MULTI_HOME_ITEMS' : '/xul/0master_6da2b4e/server/cat/manage_multi_home_items.xul',
    'XUL_AUTH_SIMPLE' : '/xul/0master_6da2b4e/server/main/simple_auth.xul',
    'XUL_BIB_BRIEF' : '/xul/0master_6da2b4e/server/cat/bib_brief.xul',
    'XUL_BIB_BRIEF_VERTICAL' : '/xul/0master_6da2b4e/server/cat/bib_brief_vertical.xul',
    'XUL_BROWSER' : 'chrome://open_ils_staff_client/content/util/browser.xul',
    'XUL_CHECKIN' : '/xul/0master_6da2b4e/server/circ/checkin.xul',
    'XUL_BACKDATE' : '/xul/0master_6da2b4e/server/circ/backdate_post_checkin.xul',
    'XUL_RENEW' : '/xul/0master_6da2b4e/server/circ/renew.xul',
    'XUL_CHECKOUT' : '/xul/0master_6da2b4e/server/circ/checkout.xul',
    'XUL_CIRC_BRIEF' : '/xul/0master_6da2b4e/server/circ/circ_brief.xul',
    'XUL_CIRC_SUMMARY' : '/xul/0master_6da2b4e/server/circ/circ_summary.xul',
    'XUL_COPY_BUCKETS_QUICK' : '/xul/0master_6da2b4e/server/cat/copy_buckets_quick.xul',
    'XUL_COPY_BUCKETS' : '/xul/0master_6da2b4e/server/cat/copy_buckets.xul',
    'XUL_COPY_DETAILS' : '/xul/0master_6da2b4e/server/circ/copy_details.xul',
    'XUL_COPY_EDITOR' : '/xul/0master_6da2b4e/server/cat/copy_editor.xul',
    'XUL_COPY_LOCATION_EDIT' : '/xul/0master_6da2b4e/server/admin/copy_locations.xhtml',
    'XUL_COPY_NOTES' : '/xul/0master_6da2b4e/server/cat/copy_notes.xul',
    'XUL_COPY_STATUS' : '/xul/0master_6da2b4e/server/circ/copy_status.xul',
    'XUL_COPY_SUMMARY' : '/xul/0master_6da2b4e/server/cat/copy_summary.xul',
    'XUL_COPY_VOLUME_BROWSE' : '/xul/0master_6da2b4e/server/cat/copy_browser.xul',
    'XUL_DEBUG_CONSOLE' : 'chrome://global/content/console.xul',
    'XUL_DEBUG_FIELDMAPPER' : '/xul/0master_6da2b4e/server/util/fm_view.xul',
    'XUL_DEBUG_FILTER_CONSOLE' : '/xul/0master_6da2b4e/server/util/filter_console.xul',
    'XUL_DEBUG_SHELL' : '/xul/0master_6da2b4e/server/util/shell.html',
    'XUL_DEBUG_XULEDITOR' : '/xul/0master_6da2b4e/server/util/xuledit.xul',
    'XUL_DO_NOT_AUTO_ATTEMPT_PRINT_SETTING' : '/xul/0master_6da2b4e/server/admin/do_not_auto_attempt_print_setting.xul',
    'XUL_FANCY_PROMPT' : '/xul/0master_6da2b4e/server/util/fancy_prompt.xul',
    'XUL_HOLD_CAPTURE' : '/xul/0master_6da2b4e/server/circ/hold_capture.xul',
    /*'XUL_HOLD_PULL_LIST' : '/xul/0master_6da2b4e/server/admin/hold_pull_list.xhtml',*/
    'XUL_HOLD_PULL_LIST' : '/xul/0master_6da2b4e/server/patron/holds.xul',
    'XUL_HOLDS_BROWSER' : '/xul/0master_6da2b4e/server/patron/holds.xul',
    'XUL_HOLD_DETAILS' : '/xul/0master_6da2b4e/server/patron/hold_details.xul',
    'XUL_HOLD_CANCEL' : '/xul/0master_6da2b4e/server/patron/hold_cancel.xul',
    'XUL_IN_HOUSE_USE' : '/xul/0master_6da2b4e/server/circ/in_house_use.xul',
    'XUL_LIST_CLIPBOARD' : '/xul/0master_6da2b4e/server/util/list_clipboard.xul',
    'XUL_LOCAL_ADMIN' : '/xul/0master_6da2b4e/server/admin/index.xhtml',
    'XUL_LOGIN_DATA' : '/xul/0master_6da2b4e/server/main/data.xul', 
    'XUL_MARC_NEW' : '/xul/0master_6da2b4e/server/cat/marc_new.xul',
    'XUL_MARC_EDIT' : '/xul/0master_6da2b4e/server/cat/marcedit.xul',
    'XUL_MARC_VIEW' : '/xul/0master_6da2b4e/server/cat/marc_view.xul',
    'XUL_MENU_FRAME' : 'chrome://open_ils_staff_client/content/main/menu_frame.xul',
    'XUL_NON_CAT_LABEL_EDIT' : '/xul/0master_6da2b4e/server/admin/non_cat_types.xhtml',
    'XUL_OFFLINE_UPLOAD_XACTS' : '/xul/0master_6da2b4e/server/admin/upload_xacts.xhtml',
    'XUL_OFFLINE_MANAGE_XACTS' : '/xul/0master_6da2b4e/server/admin/offline_manage_xacts.xul',
    'XUL_OFFLINE_MANAGE_XACTS_CGI' : '/cgi-bin/offline/offline.pl',
    'XUL_OFFLINE_GENERATE_WIDGETS' : '/xul/0master_6da2b4e/server/main/gen_offline_widgets.xul',
    'XUL_REMOTE_OPAC_WRAPPER' : '/xul/0master_6da2b4e/server/cat/opac.xul',
    'XUL_OPAC_WRAPPER' : 'chrome://open_ils_staff_client/content/cat/opac.xul',
    'XUL_PATRON_BARCODE_ENTRY' : '/xul/0master_6da2b4e/server/patron/barcode_entry.xul',
    'XUL_PATRON_BILLS' : '/xul/0master_6da2b4e/server/patron/bill2.xul',
    'XUL_PATRON_BILL_CC_INFO' : '/xul/0master_6da2b4e/server/patron/bill_cc_info.xul',
    'XUL_PATRON_BILL_CHECK_INFO' : '/xul/0master_6da2b4e/server/patron/bill_check_info.xul',
    'XUL_PATRON_BILL_DETAILS' : '/xul/0master_6da2b4e/server/patron/bill_details.xul',
    'XUL_PATRON_BILL_HISTORY' : '/xul/0master_6da2b4e/server/patron/bill_history.xul',
    'XUL_PATRON_BILL_WIZARD' : '/xul/0master_6da2b4e/server/patron/bill_wizard.xul',
    'XUL_PATRON_BILL_ALTERNATE_VIEW' : '/xul/0master_6da2b4e/server/patron/bill2.xul',
    'XUL_PATRON_DISPLAY' : '/xul/0master_6da2b4e/server/patron/display.xul',
    'XUL_PATRON_HORIZ_DISPLAY' : '/xul/0master_6da2b4e/server/patron/display_horiz.xul',
    'XUL_PATRON_EDIT' : '/eg/actor/user/register',
    'XUL_PATRONS_DUE_REFUNDS' : '/xul/0master_6da2b4e/server/admin/patrons_due_refunds.xul',
    'XUL_USER_PERM_EDITOR' : '/xul/0master_6da2b4e/server/patron/user_edit.xhtml',
    'XUL_PATRON_HOLDS' : '/xul/0master_6da2b4e/server/patron/holds.xul',
    'XUL_PATRON_INFO_NOTES' : '/xul/0master_6da2b4e/server/patron/info_notes.xul',
    'XUL_PATRON_INFO_STAT_CATS' : '/xul/0master_6da2b4e/server/patron/info_stat_cats.xul',
    'XUL_PATRON_INFO_SURVEYS' : '/xul/0master_6da2b4e/server/patron/info_surveys.xul',
    'XUL_PATRON_INFO_GROUP' : '/xul/0master_6da2b4e/server/patron/info_group.xul',
    'XUL_PATRON_ITEMS' : '/xul/0master_6da2b4e/server/patron/items.xul',
    'XUL_PATRON_SEARCH_FORM' : '/xul/0master_6da2b4e/server/patron/search_form.xul',
    'XUL_PATRON_HORIZONTAL_SEARCH_FORM' : '/xul/0master_6da2b4e/server/patron/search_form_horiz.xul',
    'XUL_PATRON_SEARCH_RESULT' : '/xul/0master_6da2b4e/server/patron/search_result.xul',
    'XUL_PATRON_SUMMARY' : '/xul/0master_6da2b4e/server/patron/summary.xul',
    'XUL_PRE_CAT' : '/xul/0master_6da2b4e/server/circ/pre_cat_fields.xul',
    'XUL_PRINT_LIST_TEMPLATE_EDITOR' : '/xul/0master_6da2b4e/server/circ/print_list_template_editor.xul',
    'XUL_RECORD_BUCKETS' : '/xul/0master_6da2b4e/server/cat/record_buckets.xul',
    'XUL_RECORD_BUCKETS_QUICK' : '/xul/0master_6da2b4e/server/cat/record_buckets_quick.xul',
    'XUL_REMOTE_BROWSER' : '/xul/0master_6da2b4e/server/util/rbrowser.xul',
    'XUL_SERIAL_ITEM_EDITOR' : '/xul/0master_6da2b4e/server/serial/sitem_editor.xul',
    'XUL_SERIAL_NOTES' : '/xul/0master_6da2b4e/server/serial/notes.xul',
    'XUL_SERIAL_SELECT_AOU' : '/xul/0master_6da2b4e/server/serial/select_aou.xul',
    'XUL_SERIAL_SELECT_UNIT' : '/xul/0master_6da2b4e/server/serial/select_unit.xul',
    'XUL_SERIAL_SERCTRL_MAIN' : '/xul/0master_6da2b4e/server/serial/serctrl_main.xul',
    'XUL_SPINE_LABEL' : '/xul/0master_6da2b4e/server/cat/spine_labels.xul',
    'XUL_STAGED_PATRONS' : '/xul/0master_6da2b4e/server/patron/staged.xul',
    'XUL_STANDALONE' : 'chrome://open_ils_staff_client/content/circ/offline.xul',
    'XUL_STANDING_PENALTIES' : '/xul/0master_6da2b4e/server/patron/standing_penalties.xul',
    'XUL_NEW_STANDING_PENALTY' : '/xul/0master_6da2b4e/server/patron/new_standing_penalty.xul',
    'XUL_EDIT_STANDING_PENALTY' : '/xul/0master_6da2b4e/server/patron/edit_standing_penalty.xul',
    'XUL_SCAN_ITEM_AS_MISSING_PIECES' : '/xul/0master_6da2b4e/server/circ/missing_pieces.xul',
    'XUL_STAT_CAT_EDIT' : '/xul/0master_6da2b4e/server/admin/stat_cat_editor.xhtml',
    'XUL_SURVEY_WIZARD' : 'chrome://open_ils_staff_client/content/admin/survey_wizard.xul',
    'XUL_TIMESTAMP_DIALOG' : '/xul/0master_6da2b4e/server/util/timestamp.xul',
    'XUL_TRIGGER_EVENTS' : '/xul/0master_6da2b4e/server/patron/trigger_events.xul',
    'XUL_USER_BUCKETS' : '/xul/0master_6da2b4e/server/patron/user_buckets.xul',
    'XUL_VERIFY_CREDENTIALS' : '/xul/0master_6da2b4e/server/main/verify_credentials.xul',
    'XUL_VOLUME_BUCKETS' : '/xul/0master_6da2b4e/server/cat/volume_buckets.xul',
    'XUL_VOLUME_COPY_CREATOR' : '/xul/0master_6da2b4e/server/cat/volume_copy_editor.xul',
    'XUL_VOLUME_COPY_CREATOR_HORIZONTAL' : '/xul/0master_6da2b4e/server/cat/volume_copy_editor_horiz.xul',
    'XUL_VOLUME_COPY_CREATOR_ORIGINAL' : '/xul/0master_6da2b4e/server/cat/volume_copy_creator.xul',
    'XUL_VOLUME_EDITOR' : '/xul/0master_6da2b4e/server/cat/volume_editor.xul',
    'XUL_WORK_LOG' : '/xul/0master_6da2b4e/server/admin/work_log.xul',
    'XUL_WORKSTATION_INFO' : '/xul/0master_6da2b4e/server/main/ws_info.xul',
    'XUL_Z3950_IMPORT' : '/xul/0master_6da2b4e/server/cat/z3950.xul',
    'TEST_HTML' : '/xul/0master_6da2b4e/server/main/test.html',
    'TEST_XUL' : '/xul/0master_6da2b4e/server/main/test.xul',
    'CONIFY' : '/conify/' + LOCALE + '/global',
    'CONIFY_MANAGE_PARTS' : '/eg/conify/global/biblio/monograph_part',
    'EG_WEB_BASE' : '/eg',
    'XUL_LOCAL_ADMIN_BASE' : '/xul/0master_6da2b4e/server/admin',
    'XUL_REPORTS' : '/reports/oils_rpt.xhtml',
    'EG_ACQ_PO_VIEW' : '/eg/acq/po/view',
    'XUL_SERIAL_BATCH_RECEIVE': '/xul/0master_6da2b4e/server/serial/batch_receive.xul'
}
